...
\usepackage{geometry}
\usepackage{graphicx}
% \usepackage[hidelinks,bookmarksnumbered=true,hyperfootnotes=true]{hyperref}
% \usepackage{bookmark}
\usepackage{lipsum}
\usepackage{pdfpages}
\usepackage{perpage}
...
\renewcommand{\subsectionmark}[1]{%
  ...
  \fi
  \markboth{\theheadermark}{\theheadermark}%
}
...
\input{src/note_cmd}
\input{src/other_cmd}
\input{src/appendix_cmd}

\input{src/overwrite_cmd}
